...
if ($LegacyPromptSudo) {
    ...
    $remoteCommands.Add("fi")
    $remoteCommands.Add("if [ -f '$RemoteStageDir/server/server-icon.png' ]; then")
    $remoteCommands.Add("  install -m 644 '$RemoteStageDir/server/server-icon.png' '$RemoteServerRoot/server-icon.png'")
    $remoteCommands.Add("fi")
