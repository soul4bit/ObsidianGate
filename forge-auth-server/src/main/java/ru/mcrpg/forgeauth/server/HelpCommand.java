...
final class HelpCommand {
    ...
    private static final List<HelpSection> PLAYER_SECTIONS = Collections.unmodifiableList(Arrays.asList(
        ...
        section(
            ...
            entry("//expand <блоки> <направление> [...]", "//expand ", "расширить выделение; короткая команда //exp"),
            entry("//sel", "//sel", "убрать отображение текущего выделения"),
            ...
            entry("/rg show [название]", "/rg show ", "показать границы блоками"),
